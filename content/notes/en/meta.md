...
It's a recursive loop: code about the code that displays the code. Here you'll find articles about the software design of this digital garden, design decisions (like why I chose a graph view), and the "how to" of my personal knowledge management system.
...
Everything here is open source. You can explore the implementation details in the notes below or check the [repository](https://github.com/y9vad9/y9vad9.com) directly.
