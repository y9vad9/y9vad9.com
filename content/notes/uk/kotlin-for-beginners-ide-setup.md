---
date: 2022-11-22
title: "Kotlin для початківців: Основи — Налаштування середовища"
preview: "Для початку, розберімось з місцем, де будемо писати код та його запускати. Зазвичай при роботі з Котліном використовують Intellij Idea."
series: "Kotlin для початківців"
order: 2
next: "kotlin-for-beginners-variables"
...
Завантажити можна зі спеціальної утиліти ([Jetbrains Toolbox](https://www.jetbrains.com/ru-ru/toolbox-app/)) або завантажити напряму [тут](https://www.jetbrains.com/ru-ru/idea/download/).
Далі встановлюйте налаштування, що підходять саме вам (тему та ін.).

## Створення проєкту
Нумо створимо наш проєкт:
![проекти](attachments/kotlin-images-ide_projects_screen_1.png)

Натискаємо на «New Project» при створенні проєкту:
![створення](attachments/kotlin-images-ide_project_creation_1.png)
...
![](attachments/kotlin-images-ide_kotlin_edu_project_1.png)
