---
date: 2022-11-22
title: "Kotlin для початківців: Основи — Цикли та Рекурсія"
preview: "Тепер же, перейдемо до досить цікавої, але, знову ж, трішки непростої теми — цикли."
series: "Kotlin для початківців"
order: 8
next: "kotlin-for-beginners-functions"
