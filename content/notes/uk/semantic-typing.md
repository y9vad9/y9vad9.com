...
preview: "Перейдіть від менталітету «це просто стрінг» до підходу «це концепція». Що таке семантична типізація в Kotlin, коли вона допомагає доменній моделі, а коли лише заважає."
date: 2025-12-24
