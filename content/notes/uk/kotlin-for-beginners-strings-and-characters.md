---
date: 2022-11-22
title: "Kotlin для початківців: Структури даних — Рядки та Символи"
preview: "Ми вже розглядали рядки як вбудований тип даних, тепер же прийшов час розібрати їх більш детально. Що ж таке рядок?"
series: "Kotlin для початківців"
order: 14
next: "kotlin-for-beginners-objects"
...
Тобто за аналогією з [діапазонами](/uk/notes/kotlin-for-beginners-cycles-and-recursion#for), де інтервал – це по суті набір чисел
...
> **💡 Варто знати** <br/>
> До речі, для символів існує окремий тип – і це `Char`. Взагалі, він може існувати й без рядка:
> ```kotlin
...
Але, розбивати це на рекурсію трішки заскладно, чи не так? Згадуючи тему про [цикли](/uk/notes/kotlin-for-beginners-cycles-and-recursion#for)
...
> }
> ```
> Тобто, тепер замість числа в змінній перед `in` у нас символ.
...
в темі про [оператори](/uk/notes/kotlin-for-beginners-operators), я розповідав, що функції можуть виражатись через функцію,
