---
date: 2022-11-22
title: "Kotlin для початківців: Основи — Шаблони рядків"
preview: "Інтерполяція рядків була створена задля того, щоб полегшувати код, який має багато змінних, які потрібно вивести."
series: "Kotlin для початківців"
order: 5
next: "kotlin-for-beginners-operators"
