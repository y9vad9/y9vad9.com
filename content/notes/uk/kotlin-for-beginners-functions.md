---
date: 2022-11-22
title: "Kotlin для початківців: Основи — Функції"
preview: "Уявіть будь-яку однотипну дію або декілька дій, яку ви робите кожен день, і дайте їй якусь назву. За приклад такого набору дій візьмемо біг."
series: "Kotlin для початківців"
order: 9
next: "kotlin-for-beginners-scope-visibility"
...
![run](attachments/kotlin-images-ide_run_hello_world_1.png)

І в списку, що випав, натискаємо 'Run Main.kt'.
І отримуємо результат:

![run1](attachments/kotlin-images-ide_run_hello_world_2.png)
