---
date: 2022-11-22
title: "Kotlin для початківців: Структури даних — Абстракції"
preview: "Ускладнимо завдання: у нас є притулок з домашніми тваринами, і нам потрібно зберігати уніфіковану інформацію про кожну тварину."
series: "Kotlin для початківців"
order: 17
next: "kotlin-for-beginners-null-safety"
...
![Наслідування](attachments/kotlin-images-pet_object.png)
...
б визначено початково (у нас все має визначати спадкоємець). Тому найкращим варіантом буде interface:
...
```kotlin
class Cat(override val name: String, override val age: Int) : Pet {
    override fun sound(): String = "meow<3"
}

class Dog(override val name: String, override val age: Int) : Pet {
...
class Parrot(override val name: String, override val age: Int) : Pet {
    override fun sound(): String = "squawk!"
    fun fly() {
        println("pretend parrot is flying..")
    }
}
```
